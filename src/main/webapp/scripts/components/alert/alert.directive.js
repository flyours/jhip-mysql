                ...
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('jhipsterMysqlApp.httpError', function (event, httpResponse) {
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-jhipsterMysqlApp-error');
                                var entityKey = httpResponse.headers('X-jhipsterMysqlApp-params');
                                if (errorHeader) {
                                    ...
                                    for (i = 0; i < httpResponse.data.fieldErrors.length; i++) {
                                        ...
                                        var fieldName = $translate.instant('jhipsterMysqlApp.' + fieldError.objectName + '.' + convertedField);
