...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "jhipster_mysql@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "jhipster_mysql API";

        private String description = "jhipster_mysql API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "jhipster_mysql";
